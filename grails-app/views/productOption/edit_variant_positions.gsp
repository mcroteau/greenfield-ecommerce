...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<g:form action="update_variant_positions" method="post" id="${productOptionInstance.id}">
				...
				<input type="submit" value="Update Variant Positions" class="btn btn-primary" style="float:left; margin-left:30px;"/>
